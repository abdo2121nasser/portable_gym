...
class PremiumBlock extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: AppHorizontalSize.s30,vertical: AppVerticalSize.s5),
      child: InkWell(
        onTap: (){},
        child: Row(
          children: [
            Image.asset(ImageManager.kCrownImage,
            width: AppHorizontalSize.s30,
            ),
            SizedBox(width: AppHorizontalSize.s22,),
            Text(
