...
class AnswerQuestionsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          SettingCubit()..getAllQuestions(collection: collection),
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            appBar: GeneralAppBarBlock(
              title:collection ==
                  StringManager.collectionQuestionsOfMealPlan? S.of(context).mealPlan:S.of(context).questions,
            ),
            body: Column(
              children: [
                ...
                const CircularProgressIndicator(color: ColorManager.kPurpleColor,):
                GeneralButtonBlock(
                    ...
                    function: () async {
                      if (collection ==
                        ...
                        if (settCubit.validateRequests()) {
                          ...
                          getToastMessage(
                              message:
                                  S.of(context).mealPlanRequestsErrorMassage);
                        }
                      }
                    },
